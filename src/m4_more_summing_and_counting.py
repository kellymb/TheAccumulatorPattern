...
def run_test_count_cosines_from():
    ...
    # ------------------------------------------------------------------
    expected = 4
    answer = count_cosines_from(0, 6, 0)
    print('Test 2 expected:', expected)
    print('       actual:  ', answer)
    expected = 3
    answer = count_cosines_from(-3, 3, 0)
    print('Test 3 expected:', expected)
    print('       actual:  ', answer)
    expected = 5
    answer = count_cosines_from(0, 10, 0)
    print('Test 4 expected:', expected)
    print('       actual:  ', answer)
    expected = 0
    answer = count_cosines_from(-100, 100, 1)
    print('Test 5 expected:', expected)
    print('       actual:  ', answer)
    expected = 5
    answer = count_cosines_from(1, 7, -.5)
...
def run_test_sum_unit_fractions_from():
    ...
    # ------------------------------------------------------------------
    expected = 2.0833333333  # This is APPROXIMATELY the correct answer.
    answer = sum_unit_fractions_from(1, 4)
    print('Test 1 expected:', expected, '(approximately)')
    print('       actual:  ', answer)
    expected = .30202020202  # This is APPROXIMATELY the correct answer.
    answer = sum_unit_fractions_from(9, 11)
    print('Test 1 expected:', expected, '(approximately)')
    print('       actual:  ', answer)
